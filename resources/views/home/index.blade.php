...
<div class="slider-area an-1 hm-1">
    ...
    <div class="bend niceties preview-2">
        <div id="ensign-nivoslider" class="slides">	
            <img src="{{ asset('images/bg-img/bg-1.png') }}" alt="" title="#slider-direction-1"/>
        </div>
        <!-- direction 1 -->
        <div id="slider-direction-1" class="t-cn slider-direction">
            <div class="slider-content t-cn s-tb slider-1">
                <div class="title-container s-tb-c title-compress">
                    <h2 class="title1">MUSIC INSTRUCMENT</h2>
                    <h3 class="title2" >2022</h3>
                    <h4 class="title2" >Tưng bừng đón năm mới</h4>
                    <a class="btn-title" href="{{ route('get.list.article') }}">Xem thêm</a>
                </div>
            </div>	
        </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single-product first-sale">
                                <div class="product-img">
                                    ...
                                    @else
                                        @if ($hot->pro_sale > 0)
                                        <span style="right: 0;position: absolute;background-image: linear-gradient(-99deg,#ec1f1f 0%,#ff9c00 100%); padding: 1px 7px; border-radius: 10px;color: white;font-size: 13px;z-index: 3">Sale {{ $hot->pro_sale }}%</span>
                                        @endif
                                    @endif
