    ...
    <body>
        <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
            ...
            <div class="app-header header-shadow">
                ...
                <a href="{{ route('home') }}"><img src="{{ asset('images/core-img/logo.png') }}" alt=""></a>
                                                    ...
                                                    <div class="menu-header-content text-left">
                                                        <div class="widget-content p-0">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <button class="btn-pill btn-shadow btn-shine btn btn-focus"><a href="{{ route('get.logout.user') }}">Đăng xuất</a></button>
                                                                </div>
                                                                </div>
                                                        </div>
                                                    </div>
                            ...
                            <ul class="vertical-nav-menu"><br>
                                ...
                                <li class="{{ \Request::route()->getName() == 'user.update.info' ? 'mm-active' : '' }}">
                                    <a href="{{ route('user.update.info') }}">
                                        <i class="metismenu-icon pe-7s-user"></i>Thông tin cá nhân
                                    </a>
                                </li>
                                <li class="{{ \Request::route()->getName() == 'user.update.password' ? 'mm-active' : '' }}">
                                    <a href="{{ route('user.update.password') }}">
                                        <i class="metismenu-icon pe-7s-key"></i>Cập nhật mật khẩu
                                    </a>
                                </li>
                                <li class="{{ \Request::route()->getName() == 'user.product' ? 'mm-active' : '' }}">
                                    <a href="{{ route('user.product') }}">
                                        <i class="metismenu-icon pe-7s-cart"></i>Gợi ý sản phẩm bán chạy
                                    </a>
                                </li>
                            </ul>
                        </div>
