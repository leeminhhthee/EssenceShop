									...
									<div class="actions-e">
										<div class="action-buttons-single">
											<div class="add-to-cart">
												<a href="{{ route('add.shopping.cart', $proDetail->id) }}">Thêm vào giỏ</a>
											</div>
				...
				<div class="col-md-12">
					<div class="single-product-tab">
						...
						<ul class="details-tab">
							...
							<li class=""><a href="#messages" data-toggle="tab"> Đánh giá của khách hàng</a></li>
						</ul>
						  <!-- Tab panes -->
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane componet_rating col-md-offset-1" id="messages" style="margin-bottom: 20px">
								<h3 class="comment-reply-title">Các đánh giá cho {{ $proDetail->pro_name }}</h3>
														...
														<span>
															...
															<span class="post-time">{{ $rating->created_at }} &nbsp;
																...
																<span class="check" style="font-size: 10px; color: green">
																	<i class="fa fa-check-circle fa-2x"></i> Đã mua hàng tại website.
																</span>
																@endif
															</span><br>
															&nbsp;
								...
								<div class="form_rating hide">
									<div class="col-md-offset-1" style="display: flex; margin-top:15px; font-size: 15px">
										<p style="margin-bottom: 0">
											Đánh giá của bạn @if (!get_data_user('web')) <b style="color: red">*</b><i style="font-size: 10px; color: rgb(214, 13, 13)">(Bạn cần đăng nhập để gửi bình luận.)</i> @endif
										</p>		
									...
									<div class="col-md-offset-1" style="margin-top: 15px">
										...
										<a href="{{ route('post.rating.product', $proDetail->id) }}" 
											...
											class="js_rating_product" style="width: 200px; background: #288ad6;padding: 5px 10px; color: white;border-radius: 5px">Gửi đánh giá</a>
										@else
										<a href="{{ route('post.rating.product', $proDetail->id) }}"
											class="js_rating_product" style="width: 200px; background: #288ad6;padding: 5px 10px; color: white;border-radius: 5px">Gửi đánh giá</a>
										@endif
