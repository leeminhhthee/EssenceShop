...
<style>
    ...
    <!-- category-banner area start -->
		<div class="category-banner" style="background-image: url({{ asset('images/bg-img/breadcumb.jpg') }})">
			<div class="cat-heading">
				<span style="font-size: 35px; color: white;">Tất cả sản phẩm</span>
			</div>
		</div>
					...
					<div class="col-md-12">
						<div class="container-inner">
							<ul>
								...
								<li class="category3"><span>Tất cả sản phẩm</span></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="col-md-3 col-sm-12 col-xs-12 text-left">
						<div class="topbar-left">
							...
							<aside class="sidebar-content">
								...
								<ul>
									<li><a class="{{ Request::get('price') == 0 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 0]) }}" selected="selected">Mặc định</a></li>
									<li><a class="{{ Request::get('price') == 1 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 1]) }}">Dưới 1.000.000 VND</a></li>
									...
									<li><a class="{{ Request::get('price') == 6 ? 'active' : '' }}" href="{{ request()->fullUrlWithQuery(['price' => 6]) }}">Trên 30.000.000 VND</a></li>
								</ul>
							</aside>
							
							<aside class="widge-topbar">
								<div class="bar-title">
									<!-- <div class="bar-ping"><img src="{{ asset('img/bar-ping.png') }}" alt="" style="width: 50%;"></div> -->
									<h6>Popular Tags</h2>
								</div>
								<div class="exp-tags">
									<div class="tags">
										<a href="{{ request()->fullUrlWithQuery(['k' => 'slb300']) }}">SLB300</a>
										<a href="{{ request()->fullUrlWithQuery(['k' => 'trống']) }}">Trống</a>
										<a href="{{ request()->fullUrlWithQuery(['k' => 'revstar']) }}">REVSTAR</a>
										<a href="{{ request()->fullUrlWithQuery(['k' => '250']) }}">250</a>
										<a href="{{ request()->fullUrlWithQuery(['k' => '720']) }}">720</a>
									</div>
								</div>
							</aside>
						</div>
									...
									<form class="tree-most" method="get" id="form_order">
										<div class="orderby-wrapper">
											...
											<select name="orderby" class="orderby">
												...
												<option {{ Request::get('orderby') == "desc" ? "selected='selected'" : " " }} value="desc">Từ mới đến cũ</option>	
												<option {{ Request::get('orderby') == "asc" ? "selected='selected'" : " " }} value="asc">Từ cũ đến mới</option>
											...
											<div class="two-product">
												...
												<div class="single-product" style="width: 265px">
													<div class="product-img">
														...
														<span style="position: absolute;background: #e91e63; color: white; padding: 2px 6px; border-radius: 5px;font-size: 12px;z-index: 3">Tạm hết hàng</span>
														@else
															@if ($product->pro_sale > 0)
															<span style="right: 0;position: absolute;background-image: linear-gradient(-99deg,#ec1f1f 0%,#ff9c00 100%); padding: 1px 7px; border-radius: 10px;color: white;font-size: 13px;z-index: 3">Sale {{ $product->pro_sale }}%</span>
															@endif
														@endif
												...
												<div class="product-content">
													...
													<div class="actions-e">
														<div class="action-buttons">
															<div class="add-to-cart">
																<a href="{{ route('add.shopping.cart', $product->id) }}">Thêm vào giỏ</a>
															</div>
