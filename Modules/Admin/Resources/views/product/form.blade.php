                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group">
                                <label for="pro_name">Tên sản phẩm</label><span class="required"> *</span>
                                <input type="text" placeholder="Nhập tên sản phẩm..." class="form-control" value="{{ old('pro_name', isset($product->pro_name) ? $product->pro_name : '') }}" name="pro_name">
                            ...
                            <div class="form-group">
                                <label for="Describe">Mô tả ngắn</label><span class="required"> *</span>
                            ...
                            <div class="form-group">
                                <label for="qty">Số lượng</label><span class="required"> *</span>
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label for="ProductType">Sản phẩm thuộc danh mục: </label><span class="required"> *</span>   
                            ...
                            <div class="form-group">
                                <label for="Image">Hình ảnh</label><span class="required"> *</span><br>
                                <input type="file" class="form-control-file" name="pro_avatar" id="input_img">
                            </div>
                            <div class="form-group">
                                <label for="price">Đơn giá</label><span class="required"> *</span>
                                <input type="number" name="pro_price" class="form-control" value="{{ old('pro_price', isset($product->pro_price) ? $product->pro_price : '0') }}" min="0">
