   ...
   <div class="page-header">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('admin.get.list.warehouse') }}">Kho hàng</a></li>
            ...
            <div class="page-title-heading">
               ...
               <div>
                  ...
                  <div class="page-title-subheading">
                     Thống kê các sản phẩm bán chạy và tồn kho. 
                  </div>
                  </div>
               </div>
                  ...
                  <div class="card-header">
                     <form>
                        <div class="input-group">
                           <input type="search" placeholder="Tìm kiếm sản phẩm..." name="name" value="{{ \Request::get('name') }}"
                                 class="form-control">
                     ...
                     <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        <thead>
                           <tr>
                              ...
                              <th>Sản phẩm</th>
                              <th class="text-center">Đơn giá / Khuyến mãi</th>
