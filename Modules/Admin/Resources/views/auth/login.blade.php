...
<head>
    ...
    <title>Đăng nhập | Admin Essence</title>
...
<div class="container" style="margin-top: 10px;">    
    ...
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3"> 
        ...
        <div class="row">                
            <div class="iconmelon" style="margin: 0 242px">
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center"><a href="{{ route('home') }}" target="_blank">ESSENCE.com</a></div>
            </div>     
