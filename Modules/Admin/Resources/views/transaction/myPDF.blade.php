        ...
        <div class="col-12 mx-auto" style="width: 580px;  margin: 0 auto;">
            <div class="row"
                ...
                <span class="pl-3"
                    ...
                    <img src="{{ asset('images/core-img/logo.png') }}" alt="logo" style="padding-left: 212px">
                    <div style="padding-top: 30px;color: black;">
                        @foreach ($transactions as $transaction)
                        @if($transaction->id == $id)
                        <b>Ngày tạo đơn:</b> {{ $transaction->created_at->format('d-m-Y h:i:s A') }}
                        @endif
                        @endforeach
                    </div>
                </span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <b>Người gửi: Essence Shop</b>
                            <br>
                            <span>0974649644</span>
                            <br>
                            <b>Địa chỉ:</b> 470 Trần Đại Nghĩa, TP Đà Nẵng
                        </div>
                        <?php $i=1?>
                        <?php $total=0 ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 0;">
                                        {{ $view->pro_name }} (Sale: {{ $view->pro_sale }} %) * Số lượng: {{ $view->or_qty }} 
                                    </td>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    <div class="row pl-3 py-2" style="background-color: #f4f8fd; padding: 10px 0 10px 20px;">
                        <b style="color: #00509d; font-size: 18px;">ESSENCE Shop thank you for your order!</b>
                    </div>
                </div>
            </div>
        </div>
